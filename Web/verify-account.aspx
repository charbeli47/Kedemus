<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="verify-account.aspx.cs" Inherits="Web.verify_account" %>
...
<%=lang=="en"?"Verify Account":"ثبت حسابك" %>
</div>
