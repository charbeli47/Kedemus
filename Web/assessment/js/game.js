...
var shareTitle = 'Highscore on Assessment is [SCORE]';//social share score title
var shareMessage = '[SCORE] is mine new highscore on Assessment! Try it now!'; //social share score message
var bookId;
/*!
 *
...
function goPage(page){
	...
	switch(page){
		...
		case 'result':
			...
			stopGame();
			$.post('saveResult.ashx', { bookId: bookId, score: playerData.score });
			parent.document.getElementById("btn3").style.display = "none";
...
function displayCategoryName(){
	...
	categoryTitleTxt.font = "50px bariol_regularregular";
}
...
function loadXML(src){
	$.ajax({
       ...
       success: function (result) {
			...
			bookId = result.childNodes[0].attributes[0].value;
