<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessmentcategories.aspx.cs" Inherits="Web.system.resources.assessmentcategories" %>
...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Web Content
                        <small>Assessment Categories</small>
                    </h1>
                    <%--<ol class="breadcrumb">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="<%=results[i].id %>">
                                                <td><%=results[i].id %></td>
                                                <td><a href="#" id="title<%=i %>" data-type="text" data-pk="<%=results[i].id %>" data-url="resources/editRow.ashx?table=QuestionsCategories" data-title="Title"><%=results[i].title %></a></td>
                                                <td><a href="#" id="bookId<%=i %>" data-type="select" data-pk="<%=results[i].id %>" data-url="resources/editRow.ashx?table=QuestionsCategories" data-title="Level"><%=results[i].Book.title %></a></td>
...
<div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select name="bookSelect" id="bookSelect" class="form-control" runat="server"></select>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function AddRow() {
                $.post("resources/AddRow.ashx", { table: "QuestionsCategories", Rows: $("input[name='title']").val() + "|" + $("select[name='bookSelect']").val() },
                    function (data) {
                        getContent("assessmentcategories.aspx");
                        $(".modal-backdrop").hide();
                    });
            }
            function DeleteRow(id) {
                $.post("resources/DeleteRow.ashx", { table: "QuestionsCategories", tableId: id },
                    function (data) {
                        getContent("assessmentcategories.aspx");
                        $(".modal-backdrop").hide();
                    });
