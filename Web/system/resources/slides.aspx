<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slides.aspx.cs" Inherits="Web.resources.slides" %>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="<%=results[i].id %>">
                                                ...
                                                <td><img src="../Media/<%=results[i].img %>" style="height:100px" /></td>
...
<div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="resources/addSlides.ashx" id="submitForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="bookId" value="<%=Request["pageId"] %>" />
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Photos:</span>
                                    <input multiple="multiple" name="thumb" type="file" class="form-control" >
        ...
        <script type="text/javascript">
            ...
            function DeleteRow(id) {
                $.post("resources/DeleteRow.ashx", { table: "Books", tableId: id },
                    function (data) {
                        getSubPage("slides.aspx", '<%=Request["pageId"]%>');
                    });
            }
