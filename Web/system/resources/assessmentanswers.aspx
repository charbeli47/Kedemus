<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessmentanswers.aspx.cs" Inherits="Web.resources.assessmentanswers" %>
<link href="css/iCheck/all.css" rel="stylesheet" type="text/css" />
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Web Content
                        <small><%=question.title %> / Answers</small>
                    </h1>
                    <%--<ol class="breadcrumb">
...
<!-- DATA TABES SCRIPT -->
        ...
        <script type="text/javascript">
            $(function () {
                $("#example1").dataTable({ bPaginate: false });//.rowReordering({ sURL: "resources/UpdateOrder.ashx", sTable: "Slides" });
            });
            </script>
...
<div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-envelope-o"></i> Add Answers</h4>
                    </div>
                    <form action="resources/addAssessmentAnswer.ashx" id="submitForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="questionId" value="<%=Request["pageId"] %>" />
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="x" type="number" class="form-control" placeholder="X">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Y:</span>
                                    <input name="y" type="number" class="form-control" placeholder="Y">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="typetext" id="typetext" type="text" class="form-control" placeholder="Enter text here">
        ...
        <script type="text/javascript">
            ...
            function DeleteRow(id) {
                $.post("resources/DeleteRow.ashx", { table: "QuestionsAnswers", tableId: id },
                    function (data) {
                        getSubPage("assessmentanswers.aspx", '<%=Request["pageId"]%>');
                    });
            }
