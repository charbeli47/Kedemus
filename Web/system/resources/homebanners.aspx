<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homebanners.aspx.cs" Inherits="Web.resources.homebanners" %>
                        ...
                        <div class="col-xs-12">
                            <div class="box" style="width:95%;margin-left:auto;margin-right:auto;padding:10px">
                                <div class="box-header">
                                     <%if (Web.Permissions.Check(int.Parse(Request["opId"]), "Home Banners", "add"))
                                       {%>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><% if (Web.Permissions.Check(int.Parse(Request["opId"]), "Home Banners", "delete"))
        ...
        $("input[name='thumbnailupload']").on("change", function () {
            ...
            if (/^image/.test(files[0].type)) { // only image file
                ...
                reader.onloadend = function () { // set image data as background of div
                    ...
                    $.ajax({
                        type: "POST",
                        url: "resources/uploadHomeBannersImage.ashx",
                        data: { img: imRes, id: imId, field: "thumb" }
                    })
.done(function (msg) {
    getContent("homebanners.aspx");
});
                }
            }
        });
...
<div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-envelope-o"></i> Add Photos</h4>
                    </div>
                    <form action="resources/addHomeBanners.ashx" id="submitForm" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Photos:</span>
                                    <input multiple="multiple" name="thumb" type="file" class="form-control" placeholder="Thumbnail">
        ...
        <script type="text/javascript">
            ...
            function DeleteRow(id) {
                $.post("resources/DeleteRow.ashx", { table: "HomeBanners", tableId: id },
                    function (data) {
                        getContent("homebanners.aspx");
                    });
            }
